...
" value=" Submit to register ">};
    ...
    my $table2 = qq{<table width=50% border=0>
			...
			<font color=red>Please <a href="https://hive.biochemistry.gwu.edu/dna.cgi?cmd=userReg" class=blue13>click here </a> if you are trying to sign up specifically for the HIVE platform for the storage and analysis of extra-large data</font>.
