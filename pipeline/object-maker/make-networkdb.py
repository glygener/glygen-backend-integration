...
def main():
    ...
    for json_file in glycan_file_list:
        ...
        #    print " ... processed %s glycan records" % (record_count)



    record_count = 0
    site_sec_list = ["glycosylation", "mutagenesis","snv","site_annotation"]
    for json_file in protein_file_list:
        ...
        record_count += 1
        #if record_count%1000 == 0:
        #    print " ... processed %s protein records" % (record_count)
    ...
    for src_type in tree_dict:
        batch_size = 1 if src_type == "species" else 1000
        for src_id in tree_dict[src_type]:
            ...
            for dec_type in seen_dec:
                obj["linkeage"][dec_type] = seen_dec[dec_type].keys()
            obj_list.append(obj)
            record_count += 1
    ...
    print " ... final created: %s network objects" % (record_count)
